...
const configurations: { [env: string]: Configuration } = {
  ...
  development: {
    ...
    externalTokens: {
      ...
      'CRS/BUSD': ['0xe90FDA44c44fC2Ce346650317271b95F4F8e9f59', 18],
      'CRS/BNB': ['', 18],
      'DIA/BUSD': ['', 18],
      'DIA/BNB': ['', 18],
    },
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  CrystalDShareGenesisRewardPool: {
    name: 'Earn CRS by DShare',
    poolId: 2,
    sectionInUI: 0,
    contract: 'CrystalDShareGenesisRewardPool',
  ...
  CrystalDexShareGenesisRewardPool: {
    name: 'Earn CRS by DexShare',
    poolId: 3,
    sectionInUI: 0,
    contract: 'CrystalDexShareGenesisRewardPool',
