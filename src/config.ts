...
const configurations: { [env: string]: Configuration } = {
  ...
  development: {
    ...
    externalTokens: {
      ...
      DShare: ['0x26d3163b165BE95137CEe97241E716b2791a7572', 18],
      DexShare: ['0xf4914E6D97a75f014AcFcF4072f11be5CfFc4cA6', 18],
      'BUSD/BNB': ['0x58F876857a02D6762E0101bb5C46A8c1ED44Dc16', 18],
      'CRS/BUSD': ['0x3411f287c3fc5fbc1be9fcc324d47541ebf220c6', 18],
      'DIA/BNB': ['0x40f3B0A66bCa432D19d51ac9d016eCC4deCcF0B2', 18],
      'CRS/DShare': ['0x329f20A95F4a7225F95731e76558b7ba4f472b5c', 18],
    },
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  CrystalBusdLPGenesisRewardPool: {
    name: 'Earn CRS by CRS/BUSD LP',
    poolId: 2,
    sectionInUI: 0,
    contract: 'CrystalBusdLPGenesisRewardPool',
  ...
  CrystalDShareLPDiamondRewardPool: {
    name: 'Earn DIA by CRS/DShare LP',
    poolId: 2,
    sectionInUI: 2,
    contract: 'CrystalDShareLPDiamondRewardPool',
    depositTokenName: 'CRS/DShare',
    earnTokenName: 'DIA',
    finished: false,
    sort: 1,
    closedForStaking: false,
