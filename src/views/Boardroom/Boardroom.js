          ...
          <Box mt={5}>
            <Grid container justifyContent="center" spacing={3}>
                ...
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{ textTransform: 'uppercase', color: '#f9d749' }}>
                      PUSH PEG <small>(TWAP)</small>
                    </Typography>
                    <Typography>{scalingFactor} BTC</Typography>
                    <Typography>
                      <small>per 10,000 PUSH</small>
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
              ...
              <Grid item xs={12} md={2} lg={2}>
                <Card className={classes.gridItem}>
                  <CardContent align="center">
                    <Typography style={{ textTransform: 'uppercase', color: '#f9d749' }}>PSHARES Staked</Typography>
            ...
            <Grid container justifyContent="center">
              <Box mt={3} style={{ width: '600px' }}>
                <Alert variant="filled" severity="info">
                  ...
                  <a href="https://app.pushmoney.money/xpush">xPUSH</a> is a great place to put your PUSH rewards
                  , 20% of all minted PUSH goes directly to xPUSH stakers.<br /><br />
                  Please consider putting your earned PUSH into xPUSH, especially when we are not over 1.1 peg.
                </Alert>
